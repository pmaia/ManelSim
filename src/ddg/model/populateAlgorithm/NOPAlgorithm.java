 ...
 *
 */
public class NOPAlgorithm extends AbstractPopulateAlgorithm implements PopulateAlgorithm {

	/* (non-Javadoc)
	 * @see ddg.model.populateAlgorithm.PopulateAlgorithm#populateNamespace(int, int, java.util.List, ddg.util.FileSizeDistribution, java.util.Map)
	 */
